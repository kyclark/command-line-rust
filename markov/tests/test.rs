...
fn test_read_training() {
    ...
    expected3.insert("fo".to_string(), vec!["o".to_string(), "o".to_string()]);
    expected3.insert("ol".to_string(), vec!["s".to_string()]);
    expected3.insert("oo".to_string(), vec!["b".to_string(), "l".to_string()]);
    expected3.insert("ob".to_string(), vec!["a".to_string()]);
    expected3.insert("ba".to_string(), vec!["r".to_string()]);
    let chain3 =
        read_training(&vec![tmpfile.path().to_str().unwrap().to_string()], &3);
    assert!(chain3.is_ok());
    ...
    expected4.insert("foo".to_string(), vec!["b".to_string(), "l".to_string()]);
    ...
    let chain4 =
        read_training(&vec![tmpfile.path().to_str().unwrap().to_string()], &4);
    assert!(chain4.is_ok());
